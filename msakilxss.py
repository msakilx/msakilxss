...
# Author: mir sakil ahmad xs 
# GitHub: https://github.com/msakilxsboom
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : mir sakil ahmad xs .   (NORA)          \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/msakilx/msakilxbo\033[94m│".center(columns+9))
    print("│ \033[95mCoder  : msakilx             \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
